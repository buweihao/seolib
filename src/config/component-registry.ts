...
export const componentRegistry = [
  ...
  { id: "AboutCompanyInformation-001", name: "About Company Information", kind: "section", family: "About", status: "Review", source: "src/components/sections/AboutCompanyInformation.astro", reviewHref: "/library/client-previews/procurement-evidence/about/#about-company", reviewMode: "in-context" },
  { id: "AboutRecommendation-001", name: "About Recommendation", kind: "section", family: "About", status: "Review", source: "src/components/sections/AboutRecommendation.astro", reviewHref: "/library/client-previews/procurement-evidence/about/#about-recommendation", reviewMode: "in-context" },
  { id: "AboutAdvantages-001", name: "About Advantages", kind: "section", family: "About", status: "Review", source: "src/components/sections/AboutAdvantages.astro", reviewHref: "/library/client-previews/procurement-evidence/about/#about-advantages", reviewMode: "in-context" },
  { id: "AboutImageGallery-001", name: "About Image Gallery", kind: "section", family: "About", status: "Review", source: "src/components/sections/AboutImageGallery.astro", reviewHref: "/library/client-previews/procurement-evidence/about/#about-gallery", reviewMode: "in-context" },
  { id: "AboutCompanyCarousel-001", name: "About Company Carousel", kind: "section", family: "About", status: "Review", source: "src/components/sections/AboutCompanyCarousel.astro", reviewHref: "/library/client-previews/procurement-evidence/about/#about-carousel", reviewMode: "in-context" },
...
export const componentChineseNames: Record<ComponentId, string> = {
  ...
  "AboutCompanyInformation-001": "公司信息首段", "AboutRecommendation-001": "主推内容瀑布流", "AboutAdvantages-001": "选择理由优势卡", "AboutImageGallery-001": "关于我们通栏图库", "AboutCompanyCarousel-001": "公司图片轮播",
