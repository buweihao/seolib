...
export const componentChineseNames: Record<ComponentId, string> = {
  ...
  "InquiryCTA-001": "深色询盘行动区", "SplitInquiry-001": "分栏询盘准备区", "InquiryForm-001": "安全项目询盘表单", "ContactOptions-001": "联系方式选项",
  "FloatingTrustBar-001": "悬浮信任证明条", "StandardsProofRow-001": "标准证明横排", "CommercialConditionsTable-001": "商业条件表",
  "ServiceChapterAccordion-001": "服务章节折叠面板", "ServiceMarquee-001": "服务关键词跑马灯",
