...
export const normalizeInquiryPayload = (input: Record<string, unknown>): InquiryPayload => ({
  ...
  productCategory: text(input.productCategory, LIMITS.productCategory),
  cooperationModel: text(input.cooperationModel ?? input.cooperation, LIMITS.cooperationModel),
