...
| `SiteHeader-001` | Site Header | `src/components/sections/SiteHeader.astro` | Section | Review | All directions | Provide site identity, five-page navigation, current-page state, and an inquiry route | Typed brand, navigation items, current path, and optional inquiry/utility inputs | Approved cross-site navigation need; `docs/PHASE_7_PLAN.md` | Shared-data desktop/mobile navigation; no hard-coded routes, mega menu, search, or client JavaScript |
...
| `ProductsPage-001` | Products Page | `src/components/compositions/ProductsPage.astro` | Composition | Review | All directions | Organize product directions, evaluation evidence, and the next inquiry step | Prop groups derived from Page Intro, Product Families, Evidence Feature, and Inquiry CTA | Five-page IA requirement; `docs/PHASE_7_PLAN.md` | Owns only approved section order; no ecommerce or product-detail behavior |
