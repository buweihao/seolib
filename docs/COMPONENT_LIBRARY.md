...
| `SiteHeader-001` | Site Header | `src/components/sections/SiteHeader.astro` | Section | Review | All directions | Provide site identity, five-page navigation, current-page state, and an inquiry route | Typed brand, navigation items, current path, and optional inquiry/utility inputs | Approved cross-site navigation need; `docs/PHASE_7_PLAN.md` | Shared-data desktop/mobile navigation with parent-route highlighting; no hard-coded routes, mega menu, search, or client JavaScript |
...
| `ContactPage-001` | Contact Page | `src/components/compositions/ContactPage.astro` | Composition | Review | All directions | Provide a clear contact destination and prepare a useful first inquiry | Prop groups derived from Page Intro and Contact Options | Five-page IA requirement; `docs/PHASE_7_PLAN.md` | Owns only approved section order; no form submission or external integration |
...
| `RecognitionBackdropHero-001` | `src/components/patterns/hero/RecognitionBackdropHero.astro` | Approved | `RecognitionHeroContent` | Award/media/outcome-led suppliers | Per-slide verified recognition and outcome evidence | Vitelle 02 evidence-led carousel | Selected for Phase 8 procurement configuration; original multi-slide evidence collages, badges, title band, strapline, image-edge previous/next controls revealed on hover or keyboard focus, always-available touch controls, autoplay pause, keyboard access, and mobile reflow |
